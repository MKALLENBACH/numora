...
O catálogo e o runtime determinístico usados pelas Edge Functions são gerados a partir dos módulos canônicos em `src/features/diagnostic/domain`. Rode `npm run diagnostic:generate` após uma mudança.
