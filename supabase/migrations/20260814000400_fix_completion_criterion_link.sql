-- Remove the PL/pgSQL variable/column ambiguity in completion evidence linking.
-- The previous ON CONFLICT target collided with the local criterion_result_id variable.
